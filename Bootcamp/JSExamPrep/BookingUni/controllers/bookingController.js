...
router.route('/details/:hotelId').get(isAuthenticated, async (req, res) => {
...
router.route('/:hotelId/delete').get((req, res) => {
    bookingService
...
router
    ...
    .get((req, res) => {
        bookingService
            .findOne(req.params.hotelId)
            .then((hotel) => {
                res.render('edit', {
                    title: `Hotel ${hotel.name} Edit`,
                    hotel,
                });
            })
            .catch((err) => console.log(err));
    ...
    .post((req, res) => {
        bookingService
            .updateOne(req.params.hotelId, req.body)
            .then((hotel) => {
                res.render('details', {
                    title: `Hotel ${hotel.name} Info`,
                    hotel,
                });
