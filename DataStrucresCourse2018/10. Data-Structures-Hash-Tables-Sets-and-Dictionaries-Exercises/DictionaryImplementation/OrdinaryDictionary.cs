...
class OrdinaryDictionary<TKey, TValue> : IEnumerable<KeyValue<TKey, TValue>>
{
    ...
    public OrdinaryDictionary(int capacity = DefaultCapacity)
    {
    ...
    {
        foreach (var item in this.elements.Where(x => x != null))
        {
    ...
    private void Grow()
    {
        OrdinaryDictionary<TKey, TValue> newTable = new OrdinaryDictionary<TKey, TValue>(this.Capacity * 2);
