...
function createHtmlMovieInfo(movie, userCanLike, movieLikes) {
    ...
    let deleteBtn = ce(
        'a',
        {
            'class': `btn btn-danger delete ${linkClass}`,
            'data-route': `delete/${movie._id}`,
    ...
    let editBtn = ce(
        'a',
        {
            'class': `btn btn-warning ${linkClass}`,
            'data-route': `edit/${movie._id}`,
            'href': `#/edit/${movie._id}`,
        },
        'Edit'
    );
    ...
    let likeBtn = ce(
        'a',
        {
            'class': `btn btn-primary like ${linkClass}`,
            'data-route': `like/${movie._id}`,
            'href': `#/like/${movie._id}`,
        },
        'Like'
    );
    ...
    let movieDiv = ce(
        'div',
        {
            'class': 'row bg-light text-dark movie-details',
            'data-id': `${movie._id}`,
        },
        movieHeading,
        imageDiv,
